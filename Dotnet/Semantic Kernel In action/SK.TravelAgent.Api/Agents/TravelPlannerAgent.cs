...
/// <summary>
/// Agent 2 — evaluates trip feasibility and produces a day-wise itinerary
/// from the structured JSON delivered by QueryProcessorAgent.
/// </summary>
public sealed class TravelPlannerAgent
{
    ...
    public TravelPlannerAgent(Kernel kernel) => _kernel = kernel;
